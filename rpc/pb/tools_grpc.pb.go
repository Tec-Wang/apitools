...
const (
	EmailService_SendEmail_FullMethodName = "/tools.EmailService/SendEmail"
)
...
func (c *emailServiceClient) SendEmail(ctx context.Context, in *SendEmailReq, opts ...grpc.CallOption) (*SendEmailResp, error) {
...
func (UnimplementedEmailServiceServer) SendEmail(context.Context, *SendEmailReq) (*SendEmailResp, error) {
...
var EmailService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tools.EmailService",
